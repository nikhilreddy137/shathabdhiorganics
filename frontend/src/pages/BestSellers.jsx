  ...
  return (
    <div className="min-h-screen bg-white" data-testid="best-sellers-page">
      ...
      <section className="relative min-h-[88vh] md:min-h-[92vh] flex items-center justify-center overflow-hidden bg-stone-900" data-testid="bestsellers-hero">
        ...
        >
          <source src="https://assets.mixkit.co/videos/17120/17120-360.mp4" type="video/mp4" />
        </video>
            ...
            {[
              {
                ...
                video: 'https://assets.mixkit.co/videos/23781/23781-360.mp4',
                poster: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?auto=format&fit=crop&w=600&q=80',
              },
              {
                title: 'Hand-Sorted',
                video: 'https://assets.mixkit.co/videos/45379/45379-360.mp4',
                poster: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?auto=format&fit=crop&w=600&q=80',
              },
              {
                title: 'Cold Pressing',
                video: 'https://assets.mixkit.co/videos/45782/45782-360.mp4',
                poster: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?auto=format&fit=crop&w=600&q=80',
              },
              {
                title: 'Spice Markets',
                video: 'https://assets.mixkit.co/videos/25915/25915-360.mp4',
